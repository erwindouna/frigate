...
- `title` (string): A concise title summarizing the specific action you describe in `scene`. Use names from "Objects in Scene" when you visually observe them. When multiple objects/actions are present, prioritize the most prominent or first-occurring.
